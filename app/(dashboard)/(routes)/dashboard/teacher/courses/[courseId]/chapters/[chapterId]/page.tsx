...
import { ArrowLeft, Eye, LayoutDashboard, Lock, Video } from "lucide-react";
import Link from "next/link";
import { redirect } from "next/navigation";
import ChapterTitleForm from "./_components/chapter-title-form";
import ChapterDescriptionForm from "./_components/chapter-desc-form";
import ChapterAccessForm from "./_components/chapter-access-form.tsx";
  ...
  return (
    <>
      {!chapter.isPublished && (
        <Banner
          variant={"warning"}
          label="This chapter isn't published & won't be visible in the course."
        />
      )}
      <div className="p-6">
